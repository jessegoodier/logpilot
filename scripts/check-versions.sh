...
grep "^version = " charts/kube-web-log-viewer/pyproject.toml 2>/dev/null || echo "  Not found"
echo ""
...
grep "^__version__" charts/kube-web-log-viewer/src/__init__.py 2>/dev/null || echo "  Not found"
echo ""

echo "⎈ Helm Chart Versions:"
echo "Chart.yaml:"
grep -E "^(version|appVersion):" charts/kube-web-log-viewer/Chart.yaml 2>/dev/null || echo "  Not found"
echo ""
